...
หมายเหตุ: opponent ปัจจุบันแสดง UUID ที่ตัดเหลือ 8 ตัว ไม่ใช่ข้อความที่ถูก encrypt

## 3. Room settings ก่อนเริ่มเกม

Host ตั้งค่าและ server broadcast ให้ทุกคนเห็น จากนั้น lock ค่าเมื่อเริ่ม match:

- เวลาต่อเทิร์น เช่น Off / 30 / 45 / 60 / 90 / 120 วินาที
- จำนวนผู้เล่น 3–6 คน
...
- “มีไพ่กี่ใบ” หมายถึงจำนวนไพ่ต่อผู้เล่น, จำนวนไพ่ทั้งสำรับ หรือจำนวน Joker
- เมื่อเวลาหมดให้จบเทิร์น, สุ่ม action, เปิดไพ่ลงโทษ หรือแพ้เทิร์นแบบใด
- อนุญาตค่ากำหนดเองหรือเลือกได้เฉพาะ preset ที่ server รับรอง
...
- ถ้า rank เท่ากันจะวัดสี, วัดดอก หรือให้เฉพาะคนที่เสมอกันเลือกใหม่
- ถ้าได้ Joker มากกว่าหนึ่งคนจะตัดสินอย่างไร
- เปิดไพ่ทันทีที่เลือกหรือเปิดพร้อมกันหลังทุกคนเลือก
- ผู้เล่นที่ไม่เลือกภายในเวลาจะสุ่มให้หรือถูกนำออกจากห้อง
