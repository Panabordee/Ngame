...
5. Build /client as a minimal React + Vite card-table interface that connects to the Colyseus room. Keep developer state in tooling/tests; do not render raw JSON debug state in the normal player interface.
